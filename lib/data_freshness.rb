...
class DataFreshness
  S3_LOCATIONS = {
    ...
    gravity_account_activies: { bucket: 'artsy-data', prefix: 'reports/gravity.account_activies/' },
    gravity_artist_series_artworks: { bucket: 'artsy-data', prefix: 'reports/gravity.artist_series_artworks/' },
    ...
    exchange_orders: { bucket: 'artsy-data', prefix: 'reports/exchange_production._orders/' },
