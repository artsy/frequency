...
class DataFreshness
  S3_LOCATIONS = {
    ...
    homefeed_artist_reco: { bucket: 'artsy-zenith-production', prefix: 'artist_recommendations/' },
    homefeed_artwork_reco: { bucket: 'artsy-zenith-production', prefix: 'artwork_recommendations/' },
    ...
    trending_score: { bucket: 'artsy-motion-production', prefix: 'trending_score/' },
    ...
    exchange_admin_notes: { bucket: 'artsy-data', prefix: 'reports/exchange.admin_notes/' },
    exchange_fraud_reviews: { bucket: 'artsy-data', prefix: 'reports/exchange.fraud_reviews/' },
    exchange_fulfillments: { bucket: 'artsy-data', prefix: 'reports/exchange.fulfillments/' },
    exchange_line_item_fulfillments: { bucket: 'artsy-data', prefix: 'reports/exchange.line_item_fulfillments/' },
    exchange_line_items: { bucket: 'artsy-data', prefix: 'reports/exchange.line_items/' },
    exchange_offers: { bucket: 'artsy-data', prefix: 'reports/exchange.offers/' },
    exchange_orders: { bucket: 'artsy-data', prefix: 'reports/exchange.orders/' },
    exchange_shipments: { bucket: 'artsy-data', prefix: 'reports/exchange.shipments/' },
    exchange_shipping_quote_requests: { bucket: 'artsy-data', prefix: 'reports/exchange.shipping_quote_requests/' },
    exchange_shipping_quotes: { bucket: 'artsy-data', prefix: 'reports/exchange.shipping_quotes/' },
    exchange_state_histories: { bucket: 'artsy-data', prefix: 'reports/exchange.state_histories/' },
    exchange_transactions: { bucket: 'artsy-data', prefix: 'reports/exchange.transactions/' },
    impulse_assessments: { bucket: 'artsy-data', prefix: 'reports/impulse.assessments/' },
    ...
    gravity_account_activities: { bucket: 'artsy-data', prefix: 'reports/gravity.account_activities/' },
